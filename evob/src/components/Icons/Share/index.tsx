...
export const ShareIcon = ({ color = "#362828", width = 24, height = 24 }: IconProps) => {
    return (
        <IconContainer>
            <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M7.726 13.0065C8.00406 12.5293 8.61631 12.3679 9.09348 12.646L15.9235 16.626C16.4007 16.9041 16.5621 17.5163 16.284 17.9935C16.006 18.4707 15.3937 18.6321 14.9165 18.354L8.08653 14.374C7.60935 14.096 7.44794 13.4837 7.726 13.0065Z"
                    fill={color}
                />
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M16.2737 6.00598C16.5521 6.48298 16.391 7.09532 15.914 7.37369L9.09403 11.3537C8.61703 11.6321 8.00469 11.471 7.72632 10.994C7.44795 10.517 7.60898 9.90468 8.08598 9.62632L14.906 5.64632C15.383 5.36795 15.9953 5.52897 16.2737 6.00598Z"
                    fill={color}
                />
            </svg>
        </IconContainer>
